...
```
  ...
  (советник)(код) (группа) (документы)   (твои агенты)
     ...
     │ $20 / мес  │   │ у каждого,  │   │ общий Pool-   │
     │ (безлимит) │   │ git-backed  │   │  маркетплейс  │
     └────────────┘   └─────────────┘   └───────────────┘
