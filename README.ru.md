...
Одна команда: скачает последний код, обновит зависимости при необходимости и перезапустит сервис. Данные в безопасности -- `.env`, память агентов, `SOUL.md` и настройки не затрагиваются.
